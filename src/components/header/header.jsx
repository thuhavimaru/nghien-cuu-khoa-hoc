...
const Header = () => {
  return (
    <header className="header">
      <div className="header-gradient-overlay" /> {/* Layer gradient */}

      <div className="header-left">
        <img
          src="/images/logo.png" // Logo VMU thật
          alt="VMU Logo"
      ...
      <div className="header-right">
        ...
        <div className="header-user">
          <div className="header-avatar">
            <img src="https://ui-avatars.com/api/?name=Admin+VMU&background=14b8a6&color=fff" alt="Admin" />
          </div>
